    ...
    return (
      ...
      >
        ...
        >
          ...
          <h2>Prophesea Fishing Tracker | Web App | Coming Soon!</h2>
          <span className="image main">
            <img src={pic02} alt="" />
          </span>
          <h4>
          ...
          <h2>YSK - Digital Gallery | <br /> Web App | Coming Soon!</h2>
          <span className="image main">
            <img src={pic04} alt="" />
          </span>
          <h4>
          ...
          <h2>Vida Healing | Web App | <br /> Coming Soon!</h2>
          <span className="image main">
            <img src={pic05} alt="" />
          </span>
          <h4>
          ...
          <h2>Cana La Reina - Social Collective | Web App | <br /> Coming Soon!</h2>
          <span className="image main">
            <img src={pic06} alt="" />
          </span>
          <h4>
